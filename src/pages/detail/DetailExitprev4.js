...
const DetailExit = () => {
    ...
    const options = [
        // a : 생명과학대학
        { value: 'a1', label: '생명과학관(동관)', image:'../../img/a_gong.jpg'},
        { value: 'a2', label: '생명과학관(서관)', image:'../../img/a_igong1.jpg'},
        { value: 'a3', label: 'CJ식품안전관', image:'../../img/a_info.jpg'},
    ...
    return (
        <div className="upper">
            ...
            <div className="photobuilding">
                ...
                {/* <img src={require("setImage").default} alt="" width="100%" height="100%" />  */}
            </div>  
        </div>
    )
}
